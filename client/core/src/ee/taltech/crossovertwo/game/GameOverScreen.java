...
public class GameOverScreen extends ScreenAdapter {
    ...
    /**
     * Constructor to initialize the GameOverScreen
     */
    public GameOverScreen(crossovertwo game) {
        this.game = game;
    }
    ...
    public void show() {
        ...
        table.add(new Label("GAME OVER", GraphicVariables.getLabelStyleForLabels())).padBottom(50);
        table.row();
    ...
    public void dispose() {
        try {
            ...
            System.out.println("Error disposing GameOverScreen - it was likely never shown.");
        }
